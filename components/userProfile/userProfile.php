    ...
    <div class="profile">
        <section class="profile__description">
            ...
            <div class="profile__wallpaper">
                <img class="img__cover" src="<?php echo $wallPaper ?>" alt="">
            ...
            <div class="profile__info">
                ...
                <div class="profile__btns-wrapper">
                    <button id="writeMsg" data-id="<?php echo $userID ?>" class="profile__btns material-icons-outlined profile__messages-btn">
        ...
        <script src="/components/userProfile/userProfile.js"></script>
    </div>
</main>