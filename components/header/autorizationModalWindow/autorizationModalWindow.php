    ...
    <div class="log-in__mobile-block">
        ...
        <div class="registration__mobile">
            ...
            <form id="registrationFormMobile" style="display: block;" method="POST" class="registration__form-mobile" action="">
                ...
                <input class="log-in__input" name="name_reg" type="text" placeholder="Имя" required>
                <input class="log-in__input" name="email_reg" type="email" placeholder="Почта" required>
                <input class="log-in__input" name="password_reg" type="password" placeholder="Пароль" required>
