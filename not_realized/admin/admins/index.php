        ...
        <div class="row">
            ...
            <div class="content">
                <div class="row content_row">
                    <h3 class="content__title">Администраторы</h3>
                    <a href="admin_add.php"><button class="btn">Добавить</button></a>
                </div>
                <hr>
                <div class="row card__rows">
                    ...
                    ?>
                        <div class="card">
                            ...
                            <ul>
                                <li class="card__item"><a href="delete_admin.php?id=<?= $response['id'] ?>" class="card__link">Удалить</a></li>
                            </ul>
                        </div>
                    <?php
                    }
