...
window.onhashchange=function(){
    ...
    else if(path==='popular.php'){
        
    }
    else if(path==='newContent.php'){

    }
    else if(path==='marks.php'){

    }
    else if(path==='mySubscriptions.php'){

    }
    else if(path==='userProfile.php'){

    }
    else if(path==='userSubscriptions.php'){
